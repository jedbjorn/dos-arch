...
_FILEPATH_ENTRIES = [
    ...
    ("bootstrap",     ROOT / "shell_core" / "scripts" / "bootstrap.py",  "file", "One-shot bootstrapper — schema + skills + Forge + first user + Exp-Prime"),
    ("db_init",       ROOT / "shell_core" / "scripts" / "db_init.py",    "file", "Seeding library — seed_skills / ensure_forge / seed_exp_prime"),
    ...
    ("assets_dir",    ROOT / "shell_core" / "assets",                    "dir",  "Seed data — skills/*.md + shells/{forge,exp-prime}.md"),
