...
INSERT OR IGNORE INTO tools (name, description, kind, spec, handler) VALUES (
  'shared',
  'Inspect this shell''s shared host↔container handoff folder. Returns the absolute path plus a one-level listing (count + most-recent entry per subdir) of redlines/, review/, repos/, backups/.',
  'builtin',
