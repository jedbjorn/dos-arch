...
description: Database migration best practices: safety checklist, schema vs data migrations, rollbacks, zero-downtime changes. Use when creating or altering tables, adding columns, or running backfills.
category: workflow
common: 0
---
# database-migrations
